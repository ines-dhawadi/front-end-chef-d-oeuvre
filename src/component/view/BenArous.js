...
//.filter(el=>el.gouvernorat==="ben arous")
// center={[36.743500, 10.231976]}
...
<div className="row">
  ...
  <div className="col-md-4 col col-sm-12"><div className="all-top-part-locl"><p className="text-center"> <i id="icon-location" class="fas fa-3x fa-map-marked-alt"></i> <br></br> <br></br>Gouvernorat de ben arous<br></br>
...
<MapContainer className="w-100" center={[36.743500, 10.231976]} zoom={12} scrollWheelZoom={true}>
  <TileLayer
