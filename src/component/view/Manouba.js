...
//.filter(el=>el.gouvernorat==="Manouba")
//center={[36.805809, 10.088530]}
...
<div className="row">
  ...
  <div className="col-md-4 col col-sm-12"><div className="all-top-part-locl"><p className="text-center"> <i id="icon-location" class="fas fa-3x fa-map-marked-alt"></i> <br></br> <br></br>Gouvernorat de Manouba <br></br>
...
{artisan.filter(el=>el.gouvernorat==="Manouba").map((el,key)=>(
...
<MapContainer className="w-100" center={[36.805809, 10.088530]} zoom={12} scrollWheelZoom={true}>
  <TileLayer
